...
export const useProducts = () => {
    ...
    const openModalCreateProduct = useCallback(() => {
        ...
        setAction('create');import {useState, useCallback, useEffect} from 'react';
        import ProductCollection from '../../backbone/collections/products';
        ...
        export const useProducts = () => {
            ...
            const handleCreateProduct = useCallback((e) => {
                ...
                if (!selectedProduct?.name || !selectedProduct?.price || !selectedProduct?.quantity_in_stock) {
                ...
                newProduct.save(null, {
                    ...
                    error: (model, response) => {
                        setErrors(response?.responseJSON?.errors || ['Error creating product']);
            ...
            const handleUpdate = useCallback((e) => {
                ...
                if (existingModel) {
                    existingModel.save({
                        ...
                        error: (model, response) => {
                            setErrors(response?.responseJSON?.errors || ['Error updating product']);
                        },
            ...
            const handleDelete = useCallback(() => {
                ...
                if (modelToDelete) {
                    modelToDelete.destroy({
                        ...
                        error: (model, response) => {
                            setErrors(response?.responseJSON?.errors || ['Error deleting product']);
                        },
                        complete: () => setLoading(false),
                        wait: true,
                    });
